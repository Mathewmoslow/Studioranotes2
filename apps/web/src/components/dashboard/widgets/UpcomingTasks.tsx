...
export default function UpcomingTasks() {
  ...
  const upcomingTasks = React.useMemo(() => {
    ...
    return upcoming.map(task => {
      ...
      const rawDueDate = task.dueDate instanceof Date ? task.dueDate : new Date(task.dueDate)
      const dueDate = isNaN(rawDueDate.getTime()) ? new Date() : rawDueDate
      ...
      else dueDateText = format(dueDate, 'MMM d')
